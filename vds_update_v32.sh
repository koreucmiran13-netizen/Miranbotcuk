#!/bin/bash
# ============================================================
# MiranBot v3.2 — GitHub'dan doğrudan güncelleme
# VDS'te çalıştırın:
...
echo "[MiranBot v3.2] Dosyalar GitHub'dan çekiliyor..."
FAIL=0
...
echo "[MiranBot v3.2] Bağımlılıklar güncelleniyor..."
npm install --production=false 2>&1 | tail -1

echo "[MiranBot v3.2] Servis yeniden başlatılıyor..."
systemctl restart miranbot
sleep 5

if systemctl is-active --quiet miranbot; then
  echo "============================================="
  echo "MiranBot v3.2 başarıyla kuruldu!"
